...
-- ============================================
-- SECTION 1: CLEAN UP OLD OBJECTS (Run this first)
-- ============================================

-- Drop ALL functions that might reference non-existent columns
...
DROP TRIGGER IF EXISTS update_users_auth_updated_at ON public.users_auth CASCADE;
DROP TRIGGER IF EXISTS update_user_devices_updated_at ON public.user_devices CASCADE;
DROP TRIGGER IF EXISTS update_user_preferences_updated_at ON public.user_preferences CASCADE;
DROP TRIGGER IF EXISTS update_custom_themes_updated_at ON public.custom_themes CASCADE;
DROP TRIGGER IF EXISTS update_tab_analytics_updated_at ON public.tab_analytics CASCADE;

-- Drop all tables (if they exist from previous failed attempts)
...
-- ============================================
-- SECTION 2: UPDATE USERS_AUTH TABLE (Run after Section 1 completes)
-- ============================================

-- Add new columns to existing users_auth table
...
-- ============================================
-- SECTION 3: CREATE ALL TABLES (Run after Section 2 completes)
-- ============================================
...
-- ============================================
-- SECTION 4: CREATE INDEXES (Run after Section 3 completes)
-- ============================================
...
-- ============================================
-- SECTION 5: ENABLE RLS & CREATE POLICIES (Run after Section 4 completes)
-- ============================================
...
-- ============================================
-- SECTION 6: CREATE FUNCTIONS & TRIGGERS (Run last)
-- ============================================
...
-- DONE! All tables, indexes, policies, functions, and triggers created successfully!
